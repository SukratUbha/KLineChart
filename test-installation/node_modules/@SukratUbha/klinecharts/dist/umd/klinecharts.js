...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 10.0.0-alpha9.1', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
...
var DEFAULT_TASK_LIMIT = 5;
var TaskScheduler = /** @class */ (function () {
    function TaskScheduler(limit) {
        this._running = 0;
        this._queue = [];
        this._taskMap = new Map();
        this._limit = limit !== null && limit !== void 0 ? limit : DEFAULT_TASK_LIMIT;
    }
    TaskScheduler.prototype.add = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                            var id = task.id, handler = task.handler;
                            var run = function () {
                                _this._running++;
                                handler().then(function (result) {
                                    ...
                                    _this._running--;
                                    _this._taskMap.delete(id);
                                    _this._next();
                                });
                            };
                            var oldTaskWrapper = _this._taskMap.get(id);
                            if (isValid(oldTaskWrapper)) {
                                oldTaskWrapper.reject('canceled');
                                var index = _this._queue.indexOf(oldTaskWrapper.run);
                                if (index > -1) {
                                    _this._queue.splice(index, 1);
                                }
                            }
                            _this._taskMap.set(id, { run: run, reject: reject });
    ...
    TaskScheduler.prototype._next = function () {
        while (this._running < this._limit && this._queue.length > 0) {
            var fn = this._queue.shift();
            fn === null || fn === void 0 ? void 0 : fn();
        }
    };
    TaskScheduler.prototype.remove = function (id) {
        var taskWrapper = this._taskMap.get(id);
        if (isValid(taskWrapper)) {
            this._taskMap.delete(id);
            var index = this._queue.indexOf(taskWrapper.run);
            if (index > -1) {
    ...
    TaskScheduler.prototype.clear = function () {
        var e_1, _a;
        try {
            for (var _b = __values(this._taskMap), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = __read(_c.value, 2), reject = _d[1].reject;
                reject('canceled');
            }
        }
 ...
 * limitations under the License.
 */
function eachFigures(indicator, timestamps, defaultStyles, eachFigureCallback) {
    ...
    figures.forEach(function (figure) {
        ...
        if (isValid(figure.type)) {
            var ss = (_a = figure.styles) === null || _a === void 0 ? void 0 : _a.call(figure, {
                data: {
                    prev: result[(_b = timestamps.prev) !== null && _b !== void 0 ? _b : ''],
                    current: result[(_c = timestamps.current) !== null && _c !== void 0 ? _c : ''],
                    next: result[(_d = timestamps.next) !== null && _d !== void 0 ? _d : '']
                },
                indicator: indicator,
...
var averagePrice = {
    ...
    calc: function (dataList) {
        var totalTurnover = 0;
        var totalVolume = 0;
        return dataList.reduce(function (prev, kLineData) {
            var _a, _b;
            var avp = {};
...
var awesomeOscillator = {
    ...
    calc: function (dataList, indicator) {
        ...
        var short = 0;
        var long = 0;
        return dataList.reduce(function (prev, kLineData, i) {
            var ao = {};
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                if (i >= params[0] + params[1] - 2) {
                    ...
                    ma1Sum -= ((_b = crList[i - (params[1] - 1)].cr) !== null && _b !== void 0 ? _b : 0);
                }
                if (i >= params[0] + params[2] - 2) {
                    ...
                    ma2Sum -= ((_c = crList[i - (params[2] - 1)].cr) !== null && _c !== void 0 ? _c : 0);
                }
                if (i >= params[0] + params[3] - 2) {
                    ...
                    ma3Sum -= ((_d = crList[i - (params[3] - 1)].cr) !== null && _d !== void 0 ? _d : 0);
                }
                if (i >= params[0] + params[4] - 2) {
                    ...
                    ma4Sum -= ((_e = crList[i - (params[4] - 1)].cr) !== null && _e !== void 0 ? _e : 0);
                }
            }
            crList.push(cr);
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= maxPeriod - 1) {
                ...
                if (i >= maxPeriod + params[2] - 2) {
                    ...
                    dmaSum -= ((_a = dmaList[i - (params[2] - 1)].dma) !== null && _a !== void 0 ? _a : 0);
                }
            }
            dmaList.push(dma);
            ...
            if (i >= params[0] - 1) {
                ...
                if (i >= params[0] * 2 - 2) {
                    ...
                    if (i >= params[0] * 2 + params[1] - 3) {
                        dmi.adxr = (((_b = dmiList[i - (params[1] - 1)].adx) !== null && _b !== void 0 ? _b : 0) + adx) / 2;
                    }
                }
            }
            dmiList.push(dmi);
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0]) {
                ...
                if (i >= params[0] + params[1] - 1) {
                    ...
                    mtmSum -= ((_a = mtmList[i - (params[1] - 1)].mtm) !== null && _a !== void 0 ? _a : 0);
                }
            }
            mtmList.push(mtm);
    ...
    calc: function (dataList, indicator) {
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                obvSum -= ((_d = obvList[i - (params[0] - 1)].obv) !== null && _d !== void 0 ? _d : 0);
            }
            obvList.push(obv);
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                if (i >= params[0] + params[1] - 2) {
                    ...
                    psySum -= ((_b = psyList[i - (params[1] - 1)].psy) !== null && _b !== void 0 ? _b : 0);
                }
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                if (i >= params[0] - 1 + params[1] - 1) {
                    ...
                    rocSum -= ((_b = rocList[i - (params[1] - 1)].roc) !== null && _b !== void 0 ? _b : 0);
                }
            }
            rocList.push(roc);
    ...
    calc: function (dataList, indicator) {
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                kdj.k = ((params[1] - 1) * ((_b = (_a = kdjList[i - 1]) === null || _a === void 0 ? void 0 : _a.k) !== null && _b !== void 0 ? _b : 50) + rsv) / params[1];
                kdj.d = ((params[2] - 1) * ((_d = (_c = kdjList[i - 1]) === null || _c === void 0 ? void 0 : _c.d) !== null && _d !== void 0 ? _d : 50) + kdj.k) / params[2];
...
var stopAndReverse = {
    ...
    calc: function (dataList, indicator) {
        ...
        return dataList.reduce(function (prev, kLineData, i) {
            ...
            prev[kLineData.timestamp] = { high: high, low: low, sar: sar };
            return prev;
        }, {});
    }
};
                ...
                if (i >= params[0] * 2 - 2) {
                    ...
                    if (i >= params[0] * 3 - 3) {
                        ...
                        if (i >= params[0] * 3 + params[1] - 4) {
                            ...
                            trixSum -= ((_a = trixList[i - (params[1] - 1)].trix) !== null && _a !== void 0 ? _a : 0);
                        }
                    }
                }
            }
        ...
        dataList.forEach(function (kLineData, i) {
            ...
            if (i >= params[0] - 1) {
                ...
                if (i >= params[0] + params[1] - 2) {
                    ...
                    vrSum -= ((_c = vrList[i - (params[1] - 1)].vr) !== null && _c !== void 0 ? _c : 0);
                }
...
var StoreImp = /** @class */ (function () {
    ...
    StoreImp.prototype._addIndicatorCalcTask = function (indicator, dataLoadType) {
        ...
        void this._taskScheduler.add({
            ...
            handler: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, indicator.calcImp(this._dataList).then(function (result) { return result; })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); }
    ...
    StoreImp.prototype.removeIndicator = function (filter) {
        ...
        filterIndicators.forEach(function (indicator) {
            ...
            if (index > -1) {
                _this._taskScheduler.remove(generateTaskId(indicator.id));
            ...
            if (indicator.visible) {
                ...
                if (!isCover) {
                    ...
                    _this.eachChildren(function (data, barSpace) {
                        ...
                        var dataIndex = data.dataIndex, x = data.x, kLineNeighborData = data.data;
                        var prevX = xAxis.convertToPixel(dataIndex - 1);
                        var nextX = xAxis.convertToPixel(dataIndex + 1);
                        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
                        var prevData = (_c = result_1[(_b = (_a = kLineNeighborData.prev) === null || _a === void 0 ? void 0 : _a.timestamp) !== null && _b !== void 0 ? _b : '']) !== null && _c !== void 0 ? _c : {};
                        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
                        var currentData = (_f = result_1[(_e = (_d = kLineNeighborData.current) === null || _d === void 0 ? void 0 : _d.timestamp) !== null && _e !== void 0 ? _e : '']) !== null && _f !== void 0 ? _f : {};
                        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
                        var nextData = (_j = result_1[(_h = (_g = kLineNeighborData.next) === null || _g === void 0 ? void 0 : _g.timestamp) !== null && _h !== void 0 ? _h : '']) !== null && _j !== void 0 ? _j : {};
                        ...
                        eachFigures(indicator, {
                            prev: (_l = (_k = kLineNeighborData.prev) === null || _k === void 0 ? void 0 : _k.timestamp) !== null && _l !== void 0 ? _l : null,
                            current: (_o = (_m = kLineNeighborData.current) === null || _m === void 0 ? void 0 : _m.timestamp) !== null && _o !== void 0 ? _o : null,
                            next: (_q = (_p = kLineNeighborData.next) === null || _p === void 0 ? void 0 : _p.timestamp) !== null && _q !== void 0 ? _q : null
                        }, defaultStyles, function (figure, figureStyles, figureIndex) {
                            var _a, _b, _c;
...
var IndicatorTooltipView = /** @class */ (function (_super) {
    ...
    IndicatorTooltipView.prototype.getIndicatorTooltipData = function (indicator) {
        ...
        var legends = [];
        if (indicator.visible) {
            var kLineDataList = chartStore.getDataList();
            var kLineData = (_a = kLineDataList[dataIndex]) !== null && _a !== void 0 ? _a : {};
            var prevKLineData = (_b = kLineDataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : {};
            var data_1 = result[kLineData.timestamp];
            if (!isValid(data_1) && dataIndex === kLineDataList.length - 1) {
                data_1 = result[prevKLineData.timestamp];
            }
            var defaultValue_1 = tooltipStyles.legend.defaultValue;
            eachFigures(indicator, {
                prev: prevKLineData.timestamp,
                current: kLineData.timestamp,
                next: (_c = kLineDataList[dataIndex]) === null || _c === void 0 ? void 0 : _c.timestamp
            }, styles, function (figure, figureStyles) {
                if (isString(figure.title)) {
                    var color = figureStyles.color;
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
                    var value = data_1 === null || data_1 === void 0 ? void 0 : data_1[figure.key];
                    if (isNumber(value)) {
        ...
        if (isFunction(indicator.createTooltipDataSource)) {
            ...
            }), customName = _d.name, customCalcParamsText = _d.calcParamsText, customLegends = _d.legends, customFeatures = _d.features;
            if (tooltipTitleStyles.show) {
...
var IndicatorLastValueView = /** @class */ (function (_super) {
    ...
    IndicatorLastValueView.prototype.drawImp = function (ctx) {
        ...
        if (lastValueMarkStyles.show) {
            ...
            var dataList = chartStore.getDataList();
            var kLineData_1 = (_a = dataList[dataList.length - 1]) !== null && _a !== void 0 ? _a : {};
            var prevKLineData_1 = (_b = dataList[dataList.length - 2]) !== null && _b !== void 0 ? _b : {};
            var indicators = chartStore.getIndicatorsByPaneId(pane.getId());
            ...
            indicators.forEach(function (indicator) {
                var _a, _b;
                var result = indicator.result;
                var data = (_b = (_a = result[kLineData_1.timestamp]) !== null && _a !== void 0 ? _a : result[prevKLineData_1.timestamp]) !== null && _b !== void 0 ? _b : {};
                if (isValid(data) && indicator.visible) {
                    var precision_1 = indicator.precision;
                    eachFigures(indicator, {
                        prev: prevKLineData_1.timestamp,
                        current: kLineData_1.timestamp,
                        next: null
                    }, defaultStyles, function (figure, figureStyles) {
                        var _a;
                        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
...
var YAxisImp = /** @class */ (function (_super) {
    ...
    YAxisImp.prototype.createRangeImp = function () {
        ...
        visibleRangeDataList.forEach(function (visibleData) {
            var kLineData = visibleData.data.current;
            if (isValid(kLineData)) {
                ...
                if (inCandle && isArea) {
                    var value = kLineData[areaValueKey];
                    if (isNumber(value)) {
                ...
                indicators.forEach(function (_a) {
                    ...
                    var data = (_b = result[kLineData.timestamp]) !== null && _b !== void 0 ? _b : {};
                    figures.forEach(function (figure) {
                        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- ignore
                        var value = data[figure.key];
                        if (isNumber(value)) {
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.setCrosshair = function (crosshair) {
